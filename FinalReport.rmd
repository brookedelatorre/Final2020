...
```{r}
DataLGBTQ = filter(FinalData,LGBTQ=="straight")
barchartGC(~infected + treatment,data=DataLGBTQ)
barchartGC(~infected + treatment,data=DataLGBTQ, type="percent",main = "straight")

```
   
Among the straight participants that contracted aids a third as many took the placebo. Therefore it appears that the vaccine does have a positive effect.
